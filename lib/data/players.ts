...
export const players: Player[] = [
  ...
  makePlayer({
    ...
    cardImage: "/player-cards/turbo-technician.png",
    ...
    avatar: "/player-cards/turbo-technician.png",
  ...
  makePlayer({
    ...
    cardImage: "/player-cards/smiling-sniper.png",
    ...
    avatar: "/player-cards/smiling-sniper.png",
  ...
  makePlayer({
    ...
    cardImage: "/player-cards/nerve-ninja.png",
    ...
    avatar: "/player-cards/nerve-ninja.png",
    tags: [...allRounderTags, "spin", "fielding"],
    accent: "violet",
    accentColor: "#b24cff"
  }),
  makePlayer({
    ...
    cardImage: "/player-cards/cutter-commander.png",
    ...
    avatar: "/player-cards/cutter-commander.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "green",
    accentColor: "#32c8ff"
  }),
  makePlayer({
    id: "gaurav",
    name: "Gaurav",
    cardTitle: "Slow Poison",
    cardImage: "/player-cards/slow-poison.png",
    role: "Spin All-Rounder",
    playStyles: ["batting", "spin"],
    ...
    avatar: "/player-cards/slow-poison.png",
  ...
  makePlayer({
    ...
    cardImage: "/player-cards/sweep-samurai.png",
    role: "Pace All-Rounder",
    playStyles: ["batting", "pace", "utility"],
    ...
    avatar: "/player-cards/sweep-samurai.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "yellow",
    accentColor: "#3f8cff"
  }),
  makePlayer({
    ...
    cardImage: "/player-cards/skidball-sheriff.png",
    ...
    avatar: "/player-cards/skidball-sheriff.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "violet",
    accentColor: "#ff3636"
  }),
  makePlayer({
    id: "soman",
    name: "Soman",
    cardTitle: "Apex Crusher",
    cardImage: "/player-cards/apex-crusher.png",
    ...
    avatar: "/player-cards/apex-crusher.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "green",
    accentColor: "#52a8ff"
  }),
  makePlayer({
    ...
    cardImage: "/player-cards/tempo-tactician.png",
    ...
    avatar: "/player-cards/tempo-tactician.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "orange",
    accentColor: "#d858ff"
  }),
  makePlayer({
    ...
    avatar: "/player-cards/loopy-loyalist.png",
    tags: [...allRounderTags, "spin", "batting"],
    accent: "yellow",
    accentColor: "#ffd21c"
  }),
  makePlayer({
    ...
    cardImage: "/player-cards/quiet-quake.png",
    role: "Spin All-Rounder",
    playStyles: ["batting", "spin"],
    ...
    avatar: "/player-cards/quiet-quake.png",
  ...
  makePlayer({
    ...
    cardImage: "/player-cards/steady-sentinel.png",
    role: "Spin All-Rounder",
    playStyles: ["spin", "utility"],
    ...
    avatar: "/player-cards/steady-sentinel.png",
    tags: [...allRounderTags, "spin", "batting", "fielding"],
    accent: "green",
    accentColor: "#9cff24"
  }),
  makePlayer({
    id: "dipayan",
    name: "Dipayan",
    cardTitle: "Dipayan the Destroyer",
    cardImage: "/player-cards/dipayan-the-destroyer.png",
    ...
    avatar: "/player-cards/dipayan-the-destroyer.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "orange",
    accentColor: "#ff7a18"
  }),
  makePlayer({
    id: "dheeraj",
    name: "Dheeraj",
    cardTitle: "Surgical Chase Master",
    cardImage: "/player-cards/surgical-chase-master.png",
    ...
    avatar: "/player-cards/surgical-chase-master.png",
    tags: [...allRounderTags, "spin", "batting", "fielding"],
    accent: "yellow",
    accentColor: "#ffd21c"
  }),
  makePlayer({
    ...
    cardImage: "/player-cards/zen-sixsmith.png",
    ...
    avatar: "/player-cards/zen-sixsmith.png",
    tags: [...allRounderTags, "spin", "batting", "fielding"],
    accent: "violet",
    accentColor: "#b24cff"
  }),
  makePlayer({
    ...
    avatar: "/player-cards/calm-cannon.png",
    tags: [...allRounderTags, "pace", "batting", "fielding"],
    accent: "green",
    accentColor: "#9cff24"
  }),
  makePlayer({
    ...
    avatar: "/player-cards/steady-storm.png",
  ...
  makePlayer({
    ...
    avatar: "/player-cards/looper-legend.png",
    tags: [...allRounderTags, "spin", "fielding"],
    accent: "yellow",
    accentColor: "#ffd21c"
  }),
  ...
  makePlayer({
    ...
    avatar: "/player-cards/style-striker.png",
    tags: [...allRounderTags, "spin", "batting", "fielding"],
    accent: "green",
    accentColor: "#9cff24"
  })
